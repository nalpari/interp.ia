...
export default function Sample() {
  ...
  return (
    <div className="p-4">
      ...
      <button onClick={handleGetContent} className="mt-4 px-4 py-2 bg-blue-500 text-white rounded flex ">
        Show Content
      </button>
      <div className="mt-4">
        <h2 className="font-bold text-lg">Editor Content:</h2>
        <div className="border p-4 rounded bg-gray-50" dangerouslySetInnerHTML={{ __html: editorContent }} />
      </div>
    </div>
  )
}
